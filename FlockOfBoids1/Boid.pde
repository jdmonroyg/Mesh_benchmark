class Boid {
  ...
  void meshValuesFaceVertex(){
      ...
      facesList.add(new Face(v1, v3, v5));      
      facesList.add(new Face(v3, v5, v7));      
      facesList.add(new Face(v7, v5, v8));      
      facesList.add(new Face(v5, v6, v8));      
      facesList.add(new Face(v4, v3, v7));      
      facesList.add(new Face(v4, v7, v8));      
      facesList.add(new Face(v2, v1, v5));      
      facesList.add(new Face(v2, v5, v6));      
      facesList.add(new Face(v2, v6, v8));      
      facesList.add(new Face(v2, v4, v8));
  }
}
